 ...
 * Use the {@link rejectedrequest#newInstance} factory method to
...
public class rejectedrequest extends Fragment {
     ...
     * @return A new instance of fragment rejectedrequest.
     */
    // TODO: Rename and change types and number of parameters
    public static rejectedrequest newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      profileemail=navigationdrawer.getemail();
        return inflater.inflate(R.layout.fragment_rejectedrequest, container, false);
    }
    ...
    public void rejectrequest(){
        try {
           DatabaseReference query = FirebaseDatabase.getInstance().getReference().child("Rejected Request").child(submittedby);
            query.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
