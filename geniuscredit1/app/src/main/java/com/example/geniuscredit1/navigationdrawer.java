...
public class navigationdrawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_dashboard, R.id.nav_invoices, R.id.reportdefaulterwebview,R.id.nav_wallet,R.id.reportDefaulterFragment,R.id.viewdefaulter,R.id.settlepayment2,R.id.settlementhistory,R.id.viewcir2,R.id.checkingcir,R.id.nav_refer,R.id.nav_rate,R.id.nav_Support)
